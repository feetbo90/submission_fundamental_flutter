...
class DetailsScreens extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
        create: (_) {
      provider = RestaurantsProvider(apiService: ApiService());
      ...
      body: Consumer<RestaurantsProvider>(
        builder: (context, state, _) {
          if (state.state == ResultState.loading) {
            ...
            return myRestaurantDetail(context, state.detailRestaurant.restaurant, state);
...
myRestaurantDetail(BuildContext context, Restaurant restaurant, RestaurantsProvider restaurantsProvider) {
  return Stack(
    children: [
      SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ListView(
                        scrollDirection: Axis.horizontal,
                        children: restaurant.customerReviews!.map((reviewer) {
                          return Row(
                            children: [
                              Container(
                                width: 5,
